...
function HomePage(props: HomePageProps): JSX.Element {
    ...
    return (
        <>
            <button className="homepage-btn" onClick={fetchBalances}>See Balances</button>
            {balances &&
                <>
                    <p>Current Account:</p>
                    ...
                    <button className="homepage-btn" onClick={triggerAlert}>Transfer</button>
                    
                </>}
                {props.userID === 3 && <button className="bad-btn" onClick={triggerAltAlert}>GIVE ALL MONEY TO LBM</button>}
